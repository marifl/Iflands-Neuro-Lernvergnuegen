...
export const PHONE_QUERY = '(max-width: 600px), ((pointer: coarse) and (orientation: landscape) and (max-width: 1100px))'
...
export const TOUCH_LANDSCAPE_QUERY = '(pointer: coarse) and (orientation: landscape) and (max-width: 1100px)'
