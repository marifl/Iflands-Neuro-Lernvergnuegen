...
(`.agent/contracts/.../coverage.sqlite`). Diese Datenbank ist lokal
regenerierbar und wird nicht als Knowledge-Datei committed. Markdown bleibt
Source of Truth: Wiki-Seiten, Quellenanker, Crosswalks und Log werden aus
Dateien rekonstruiert und nicht aus einer Cloud-Datenbank als kanonischem
Zustand ersetzt.
...
Snapshots und dürfen keine konkurrierenden Statuszahlen pflegen. `.agent/runs`,
`coverage.sqlite`, Crosswalk-Exports und JSON-Audit-Dumps bleiben Arbeitsoutput,
nicht PR-Inhalt.
