...
Audit-JSONs sind Evidenz-Snapshots und Arbeitsindizes, nicht die kanonische
Status-Erzählung.
...
| Abgeleitete Evidenz | `.agent/contracts/...`, `.agent/runs/...` | reproduzierbare Snapshots, SQL, Audit-JSONs |
...
|---|---|---|
| SQLite-Coverage-Index | `.agent/contracts/2026-06-27-wiki-coverage-matrix-glossare-/coverage.sqlite` | 6322 Quellterme, 3930 `open`, 156 `partial` |
| Open-Index-Audit | `.agent/runs/wiki-coverage-open-index-audit-2026-06-29/open-index-bullshit-audit.json` | 3930 offene Zeilen triagiert |
| Open-Index-Report | `.agent/runs/wiki-coverage-open-index-audit-2026-06-29/open-index-bullshit-audit.md` | lesbarer Audit mit Samples |
...
## Nicht mehr als Status-Quelle benutzen

Diese Dateien dürfen als historische Evidenz gelesen werden, aber nicht als
aktueller Coverage-Status:

| Datei | Grund |
|---|---|
| `.agent/contracts/2026-06-27-wiki-coverage-matrix-glossare-/coverage-audit.md` | Snapshot mit älteren Counts |
| `.agent/runs/wiki-coverage-*/wiki-coverage-status.md` | Run-Snapshots mit driftenden Zwischenständen |
| `.agent/runs/wiki-coverage-bulk-*/report-*/wiki-coverage-status.md` | Batch-Zwischenstände |
| `.agent/contracts/2026-06-27-wiki-coverage-matrix-glossare-/book-crosswalk-recomputed.md` | Term-Level-Arbeitsliste, keine Status-Erzählung |
