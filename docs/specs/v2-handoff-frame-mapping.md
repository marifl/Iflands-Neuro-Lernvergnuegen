...
| `PresenterFrame.dc.html` | angepasst übernehmen | Präsentationszustand des Unified Mode | heute Sequenzen, Snapshots und Speaker-Notes-Settings, aber kein eigener Presenter-Screen | Presenter ist Zustand im Lernraum, kein separater Silo | DDlJ2fWUxHw0 / 1rYGOyvdhRm8 | 18 |
